...
public class TemporaryLoginSaveTest {
    ...
    void 홍길동_계정_조회() {
        ...
        Assertions.assertThat(actual.getEmail()).isEqualTo("doto@gmail.com");
    }
}
