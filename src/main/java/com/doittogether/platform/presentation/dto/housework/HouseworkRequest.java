...
public record HouseworkRequest(
        ...
        @NotBlank(message = "시작 날짜와 시간을 입력해주세요. 패턴은 yyyy-MM-dd과 같습니다.")
        @Schema(description = "시작 날짜와 시간", example = "2021-11-30", type = "string")
        @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd", timezone = "Asia/Seoul")
        LocalDate startDate,

        @NotBlank(message = "시작 시간을 입력해주세요. 패턴은 HH:mm과 같습니다.")
    ...
    public static HouseworkRequest of(HouseworkCategory category, String task, LocalDate startDate, LocalTime startTime, Boolean isAllDay,
                               Long userId) {
